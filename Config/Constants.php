...
class Constants
{
    ...
    const DIR_PHINE_ASSET_MODULES                   = self::DIR_PHINE_ASSETS . 'Modules/';
    const DIR_PHINE_CONFIG                          = self::DIR_PHINE . 'Config/';
    ...
    const DIR_PHINE_PHINTERFACES                    = self::DIR_PHINE . 'Phinterfaces/';
    ...
    const DIR_CUSTOM_DEBUG                          = self::DIR_CUSTOM . 'Debug/';
    ...
    const NAMESPACE_DEFAULT_CONFIGS                 = 'Config\\Defaults\\';
    
    # 1.5 Constants for script
    ...
    private function initConstants(): void
    {
        if(is_null($this->Constants))
        {
            ...
            $this->DirRoot                          = str_replace(self::DIR_PHINE_CONFIG, '', $ThisAbsoluteDir);
